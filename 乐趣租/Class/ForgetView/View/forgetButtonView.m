...
@implementation forgetButtonView
...
-(UIButton *)signBtn{
    if (!_signBtn) {
        _signBtn = [self createBtn:CGRectMake(0, 0, CGRectGetWidth(self.frame), LRYScreenpH(88)) title:@"确定" backColor:LRYCOLOR(0xF19149) iconImage:nil backgroundImage:nil tag:LOGINTAG fontSize:17 textColor:LRYCOLOR(0xFFFFFF) withShowlayer:YES Radius:22 shadowWidth:1 BorderColor:[UIColor whiteColor]];
