...
- (void)initParameters
{
    self.switchTimeInterval = 5.f;
    self.autoScrolling = YES;
}

- (void)setupViews
{
    CGFloat mainWidth = self.frame.size.width-20, mainHeight = self.frame.size.height;
    
//    UIScrollView *scrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0.f, 0.f, mainWidth, mainHeight - HEIGHT_OF_PAGE_CONTROL)];
    
    UIScrollView *scrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(10.f, 0.f, mainWidth, mainHeight)];
...
//        [imageView setImageWithURL:item.imageUrl placeholderImage:[UIImage imageNamed:@"bannerplaceholder"]];
